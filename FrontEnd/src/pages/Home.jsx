    ...
    <div className="min-h-screen bg-[#F3FBF6]">
          ...
          <div className="flex-1 space-y-8 animate-fade-in-up z-10">
            ...
            <div className="flex items-center gap-4">
              <button 
                ...
                className="bg-[#1b7a39] hover:bg-[#145c2b] text-white text-lg font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all flex items-center gap-2"
              >
              ...
              <button 
                ...
                className="bg-white hover:bg-gray-50 text-slate-700 text-lg font-bold py-4 px-8 rounded-xl border border-gray-200 shadow-sm transition-all"
              >
                Talk to AI Buddy
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Feature 1 */}
          <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-all border border-green-50 group cursor-pointer" onClick={() => navigate('/generator')}>
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Adaptive Question Generator</h3>
          ...
          {/* Feature 2 */}
          <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-all border border-green-50 group cursor-pointer" onClick={() => navigate('/companion')}>
            <div className="w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <MessageCircle className="w-8 h-8 text-blue-700" />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Bilingual Learning Companion</h3>
            <p className="text-slate-600 leading-relaxed">
          ...
          {/* Feature 3 */}
          <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-all border border-green-50 group cursor-pointer" onClick={() => navigate('/performance')}>
